...
assert(indexCode.includes("v=1.6.2"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v124"), "Expected service worker cache version bump.");

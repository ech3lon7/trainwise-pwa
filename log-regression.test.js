...
assert(indexCode.includes("v=1.5.76"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v98"), "Expected service worker cache version bump.");

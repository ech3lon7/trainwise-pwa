...
assert(indexCode.includes("v=1.5.99"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v121"), "Expected service worker cache version bump.");

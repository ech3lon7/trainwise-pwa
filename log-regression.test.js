...
assert(indexCode.includes("v=1.6.1"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v123"), "Expected service worker cache version bump.");

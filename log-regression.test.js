...
assert(indexCode.includes("v=1.5.70"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v92"), "Expected service worker cache version bump.");

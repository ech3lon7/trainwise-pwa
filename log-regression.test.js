...
assert(indexCode.includes("v=1.6.6"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v128"), "Expected service worker cache version bump.");

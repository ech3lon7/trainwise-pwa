...
assert(indexCode.includes("v=1.5.74"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v96"), "Expected service worker cache version bump.");

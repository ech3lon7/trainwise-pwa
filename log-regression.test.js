...
assert(indexCode.includes("v=1.5.71"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v93"), "Expected service worker cache version bump.");

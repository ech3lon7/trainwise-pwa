...
assert(indexCode.includes("v=1.5.90"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v112"), "Expected service worker cache version bump.");

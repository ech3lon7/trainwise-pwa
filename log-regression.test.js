...
assert(indexCode.includes("v=1.5.98"), "Expected index shell references to use bumped app version.");
...
assert(serviceWorkerCode.includes("trainwise-cache-v120"), "Expected service worker cache version bump.");
